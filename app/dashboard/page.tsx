...
export default function DashboardPage() {
  ...
  if (!resume || !parsed) return (
     <div className="min-h-screen flex items-center justify-center bg-[#05050A]">
        <Link href="/upload" className="px-8 py-4 bg-indigo-600 rounded-full font-bold">Upload Resume to Start</Link>
     </div>
  );
  ...
  return (
    <div className="min-h-screen bg-[#05050A] text-white pt-32 px-6 pb-20">
      ...
      >
        <div>
          ...
          <p className="text-zinc-400 mt-2 text-lg">
            {parsed.name} • <span className="text-indigo-400">{parsed.role}</span>
          </p>
        </div>
      ...
      {/* --- UNIFIED REPORT CONTAINER (The "De-boxed" Layout) --- */}
      <motion.div 
        ...
        <div className="bg-[#05050A] rounded-[47px] p-10 md:p-16 border border-white/5">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-20">
            ...
            <div className="lg:col-span-2 space-y-24">
              ...
              {/* ATS Section - Now floating and integrated */}
              <motion.section variants={itemVariants} className="flex flex-col md:flex-row items-center gap-12">
                <div className="relative">
                  <svg className="h-40 w-40 -rotate-90" viewBox="0 0 120 120">
                    ...
                    <motion.circle 
                      ...
                      animate={{ strokeDasharray: `${(parsed.score || 0) * 3.39} 339` }}
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-5xl font-bold">{parsed.score}</span>
                ...
                <div className="flex-1 space-y-4 text-center md:text-left">
                  ...
                  <p className="text-zinc-400 leading-relaxed text-lg">
                    Your profile is optimized for <span className="text-white font-semibold">{parsed.role}</span>. 
                    Refining the areas identified below can significantly increase your callback rate.
                  </p>
                </div>
              </motion.section>

              {/* Career Coach Section - Using vertical lines instead of boxes */}
            ...
            {/* RIGHT: Skills Sidebar (Separated by subtle border) */}
